...
(check-inf-loop (lambda () (take double 10)))
(check-inf-loop (lambda () (take1 double (lambda (x) (< x 100)))))
(check-inf-loop (lambda () (take1 double (lambda (x) (< x 64)))))
(check-inf-loop (lambda () (take1 double identity)))
(check-inf-loop (lambda () (take1 double (lambda (x) (= x 128)))))
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
